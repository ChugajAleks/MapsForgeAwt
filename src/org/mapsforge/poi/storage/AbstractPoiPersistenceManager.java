...
/**
 * Abstract implementation for the {@link PoiPersistenceManager} interface. This
 * implementation provides functionality for accessing the SQLite database.
 */
public abstract class AbstractPoiPersistenceManager implements PoiPersistenceManager {
     ...
     * (may be null).
     * @param pattern the pattern to search in points of interest data (may be
     * null).
